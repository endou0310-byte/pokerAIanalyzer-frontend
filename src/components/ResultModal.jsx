              ...
              >
                ...
                <div style={{
                  ...
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8, minWidth: 60 }}>
                    ...
                    >
                      <svg viewBox="0 0 24 24" width="28" height="28" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"></path></svg>
                    </button>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8, minWidth: 60 }}>
                    ...
                    >
                      <svg viewBox="0 0 24 24" width="30" height="30" fill="currentColor"><path d="M22 10.8c0-4.8-5.1-8.8-11.5-8.8S-1 6-1 10.8c0 4.1 3.5 7.6 8.4 8.5.6.1 1.4.3 1.1 1.1-.1.4-.4 1.5-.5 1.8-.3 1.2-1.4 2.7 1.2 1.4 5.3-2.6 11.3-6.9 11.3-12.8zM6.9 13.1H5V8.5h1.9v4.6zm3.3 0H8.3V8.5h1.9v4.6zm3.3 0h-1.9V8.5h1.7l1.3 2.1V8.5h1.9v4.6h-1.7l-1.3-2.1v2.1zm4.6 0v-4.6h3.4v1.6H20v1.4h1.5v3.2-.2z"></path></svg>
                    </button>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8, minWidth: 60 }}>
                    ...
                    >
                      <svg viewBox="0 0 24 24" width="30" height="30" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"></path></svg>
                    </button>
